...
import { HomeIcon, CalendarIcon, ClipboardDocumentListIcon, ChartBarIcon, BookOpenIcon, Cog6ToothIcon } from '@heroicons/react/24/outline';
                ...
                {navItems.map((item) => {
                    ...
                    return (
                        <button
                            ...
                            className={`flex flex-col items-center justify-center w-full h-full space-y-1 ${isActive ? 'text-amber-600 dark:text-amber-500' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'
                                }`}
                        >
